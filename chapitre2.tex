...
\paragraph{}
	...
	Après avoir obtenu des résultats satisfaisants dans la classification de motifs sur la base MNIST, nous étudions la génération de données à l'aide de réseaux de neurones en nous basant sur le concept de GAN, introduit par I. Goodfellow en 2014 \cite{Goodfellow-et-al-2016}.\\
...
\begin{figure}[ht!]
  \centering
    \includegraphics[width=\linewidth]{fig/resultatganbruitpasbiais}
    \caption{Résultats d'un GAN en mettant avec bruit et sans biais en dernière couche}
